...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Exclusão de veículo do estoque</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="<?= base_url('/') ?>">Home</a></li>
          <li class="breadcrumb-item"><a href="<?= base_url('/veiculos') ?>">Estoque</a></li>
        ...
        <div class="col-12">
          <div class="card mt-3">
            ...
            <div class="card-body">
              ...
              <h4 class="font-weight-bolder text-danger"><?= $estoque->modelo . " " . $estoque->versao . " " . $estoque->motor ?></h4>
              <hr class="my-4">
              <div class="text-center">
                <p class="lead">Confirma a exclusão do registro acima?</p>
                <a class="btn btn-secondary" href="<?= base_url('estoque'); ?>" role="button">Cancelar</a>
                <a class="btn btn-danger" href="<?= base_url('estoque/confirma_exclusao/' . encrypt($estoque->id)); ?>" role="button">Excluir</a>
              </div>
            </div>
          </div>
        </div>
