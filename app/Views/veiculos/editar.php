        ...
        <div class="col-12">
          <div class="card mt-3">
            <div class="card-header">
              <h4>Editar dados do veículo</h4>
            </div>

            <div class="card-body">

              <?php echo form_open('/', ['id' => 'form_cad_veiculo', 'class' => 'update'], ['id' => "$veiculo->id"]) ?>

              <?php echo $this->include('veiculos/_form'); ?>

              <div class="d-flex justify-content-center mt-4">
                <a href="<?php echo site_url("veiculos"); ?>" id="btn-cancelar" class="btn btn-secondary btn-sm mb-2 mx-2">Cancelar</a>
